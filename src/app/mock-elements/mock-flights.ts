...
export const FLIGHTS: Flight[] = [
  ...
  {id: 3, ship_id: 3, departure_place: 'Stockholm', departure_time: 8.00, destination_place: 'Saturn', arrival_time: 11.00},
  {id: 4, ship_id: 4, departure_place: 'Oslo', departure_time: 7.00, destination_place: 'Venus', arrival_time: 14.00},
  {id: 5, ship_id: 5, departure_place: 'Helsinki', departure_time: 10.00, destination_place: 'Mars', arrival_time: 21.00}
];
